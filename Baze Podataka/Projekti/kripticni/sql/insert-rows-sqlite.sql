...
VALUES ('korisnik1', 'korisnik@example.com', '0641234567', X'89504E470D0A1A0A0000000D49484452', 'Marko', 'Markovic', '1990-05-15', 'm');

INSERT INTO korisnici_verifikacije (korisnicko_ime, hash_sifre, hash_profila, pgp_javni_kljuc)
VALUES ('korisnik1', 'abc123hashsifre', 'def456hashprofila', X'1234567890ABCDEF');
...
INSERT INTO korisnici_podaci (korisnicko_ime, email, broj_telefona, profilna, ime, prezime, datum_rodjenja, pol)
VALUES ('korisnik2', 'korisnik2@example.com', '0641234568', X'89504E470D0A1A0A0000000D49484453', 'Ana', 'Petrovic', '1992-07-21', 'z');

INSERT INTO korisnici_podaci (korisnicko_ime, email, broj_telefona, profilna, ime, prezime, datum_rodjenja, pol)
VALUES ('korisnik3', 'korisnik3@example.com', '0641234569', X'89504E470D0A1A0A0000000D49484454', 'Ivan', 'Jovanovic', '1988-12-10', 'm');

INSERT INTO korisnici_podaci (korisnicko_ime, email, broj_telefona, profilna, ime, prezime, datum_rodjenja, pol)
VALUES ('korisnik4', 'korisnik4@example.com', '0641234570', X'89504E470D0A1A0A0000000D49484455', 'Jelena', 'Nikolic', '1995-03-30', 'z');

INSERT INTO korisnici_podaci (korisnicko_ime, email, broj_telefona, profilna, ime, prezime, datum_rodjenja, pol)
VALUES ('korisnik5', 'korisnik5@example.com', '0641234571', X'89504E470D0A1A0A0000000D49484456', 'Marko', 'Ilic', '1991-11-05', 'm');

INSERT INTO korisnici_verifikacije (korisnicko_ime, hash_sifre, hash_profila, pgp_javni_kljuc)
VALUES ('korisnik2', 'abc124hashsifre', 'def457hashprofila', X'1234567890ABCDE0');

INSERT INTO korisnici_verifikacije (korisnicko_ime, hash_sifre, hash_profila, pgp_javni_kljuc)
VALUES ('korisnik3', 'abc125hashsifre', 'def458hashprofila', X'1234567890ABCDE1');

INSERT INTO korisnici_verifikacije (korisnicko_ime, hash_sifre, hash_profila, pgp_javni_kljuc)
VALUES ('korisnik4', 'abc126hashsifre', 'def459hashprofila', X'1234567890ABCDE2');

INSERT INTO korisnici_verifikacije (korisnicko_ime, hash_sifre, hash_profila, pgp_javni_kljuc)
VALUES ('korisnik5', 'abc127hashsifre', 'def460hashprofila', X'1234567890ABCDE3');
